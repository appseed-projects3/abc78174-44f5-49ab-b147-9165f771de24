...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-15 07:06`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/abc78174-44f5-49ab-b147-9165f771de24.git
$ cd abc78174-44f5-49ab-b147-9165f771de24
```
